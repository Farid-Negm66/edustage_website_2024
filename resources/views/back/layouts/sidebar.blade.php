            ...
            <ul class="metismenu list-unstyled mm-show" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-multi-level">كورسات</span>
                    </a>
                    <ul class="sub-menu mm-collapse" aria-expanded="true">
                        <li><a href="{{ url('admin/courses') }}" key="t-level-1-1">جميع الكورسات</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-multi-level">ريفيوهات فيس بوك</span>
                    </a>
                    <ul class="sub-menu mm-collapse" aria-expanded="true">
                        <li><a href="{{ url('admin/facebook_review') }}" key="t-level-1-1">جميع الريفيوهات</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span key="t-multi-level">Faq</span>
                    </a>
                    <ul class="sub-menu mm-collapse" aria-expanded="true">
                        <li><a href="{{ url('admin/faq') }}" key="t-level-1-1">Faq</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="true">
                        <li><a href="{{ url('admin/settings') }}" key="t-level-1-1">الإعدادات</a></li>
                        <li><a href="{{ url('admin/roles_permissions') }}" key="t-level-1-1">الأذونات والتراخيص</a></li>
                    </ul>
                </li>
            </ul>
        </div>
