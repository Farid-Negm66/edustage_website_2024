                        ...
                        <div class="col-lg-12">
                            <div class="breadcrumb-inner text-center">
                                ...
                                <ul class="page-list text-center">
                                    ...
                                    <li class="rbt-breadcrumb-item"><a href="{{ url('/table_prices/morning_school/primary_stage') }}">المرحله الابتدائية</a></li>
                                    <li>
                                    ...
                                    <div class="">
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <a class="rbt-btn rbt-switch-btn rbt-switch-y bg-white" style="color: #2f57ef;font-weight: bold;margin-top: 25px;padding: 0px 60px;" href="https://forms.gle/Aqa69xSaeJUQCc1K9" target="_blank">
                ...
                <div class="col-lg-6 col-md-6 mt_sm--15">
                    <div class="course-action-bottom-right rbt-single-group">
                        ...
                        <div class="rbt-single-list action-btn text-white">
                            <a class="rbt-btn btn-white rbt-marquee-btn radius-round" href="https://forms.gle/Aqa69xSaeJUQCc1K9" target="_blank">
