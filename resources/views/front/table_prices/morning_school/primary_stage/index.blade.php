            ...
            <div class="row row--15 mt_dec--30">
                ...
                {{-- <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/1') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/1.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/1') }}" style="color: red;">الصف الاول الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/1') }}">
                ...
                {{-- <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/2') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/2.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/2') }}" style="color: red;">الصف الثاني الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/2') }}">
                ...
                {{-- <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/3') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/3.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/3') }}" style="color: red;">الصف الثالث الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/3') }}">
                ...
                <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/4') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/4.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/4') }}" style="color: red;">الصف الرابع الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/4') }}">
                ...
                <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/5') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/5.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/5') }}" style="color: red;">الصف الخامس الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/5') }}">
                ...
                <div class="col-lg-4  col-md-6  col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="service-card service-card-6 rbt-hover rbt-card">
                        <div class="inner" style="color: red;">
                            <div class="icon">
                                <a href="{{ url('table_prices/morning_school/primary_stage/6') }}">
                                    <img src="{{ url('front') }}/assets/images/table_prices/primary/6.png" alt="icons Images">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="title"><a href="{{ url('table_prices/morning_school/primary_stage/6') }}" style="color: red;">الصف السادس الابتدائي</a></h6>
                            </div>
                            <a href="{{ url('table_prices/morning_school/primary_stage/6') }}">
