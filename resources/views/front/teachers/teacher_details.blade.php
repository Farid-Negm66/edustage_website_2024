                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                                                <div class="rbt-card-img">
                                                    <iframe frameborder="0" allowfullscreen="" src="{{ $sample->video_link }}?controls=1" style="border-radius: 10px;height: 220px;display: block;margin: 0px auto;"></iframe>
                                                </div>
                                                <div class="rbt-card-body" style="padding: 5px 10px;text-align: center;">
                                                    <p style="font-size: 19px;">{{ $sample->video_desc }}</p>
                                                </div>
                                            </div>
